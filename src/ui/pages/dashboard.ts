...
<div class="card">
  <div class="card-header">
    ...
    <button class="btn btn-primary" onclick="triggerPhase('phase=reschedule','schedBtn')" id="schedBtn" title="Trigger the Intuiflow scheduler for the configured location (POST /api/v2/job/schedule). Run after Upload WOs and before Commands.">3. Reschedule</button>
